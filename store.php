...
?>
<ul class="header-links pull-right">
<li><a href="connexion.php"><i class="fa fa-user-o"></i> log in</a></li>
<li><a href="index.php"><i class="fa fa-user-o"></i> register</a></li>
...
?>
<ul class="header-links pull-right">
<li><a href="compte.php"><i class="fa fa-user-o"></i> My Account</a></li>
<li><a href="a.php"><i class="fa fa-user-o"></i> log out</a></li>
<li><a href="test.php"><i class="fa fa-user-o"></i> chat</a></li>
