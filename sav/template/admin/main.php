...
include_once ('sav/controllers/reclamationc.php');
                                ...
                                <li>
                                    ...
                                    <div class="notification-list">
                                        <div class="list-group">
                                            <a href="sav/views/reclamation.php" class="list-group-item list-group-item-action active">

                                     	
                                     	 <?PHP foreach($listereclamation as $r) { ?> 
  	<?php  if (($r['etat'])==0 )  
    ...
    { 
  	...
  	<div class="notification-list-user-block">
                                                    	<span class="notification-list-user-name">
                                                    		<?php echo $r['nom'],  str_repeat("&nbsp;", 1),  $r['prenom']; ?></span> a envoyé une reclamation.
...
<?php } ?>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="logout.php"><i class="fas fa-power-off mr-2" ></i> 
...
<li class="nav-item ">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="sav/views/reclamation.php">reclamation</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="sav/views/reviews.php">review</a>
                                        </li>
