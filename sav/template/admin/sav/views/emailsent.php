...
$m1c = new mailingc(); 
$listeemail=$m1c->afficheremail();

?>

<?PHP foreach($listeemail as $row){
    ?>
                    ...
                    <div class="email-list">
                        <div class="email-list-item email-list-item--unread">
                            <div class="email-list-actions">
                                ...
                                </label><a class="favorite active" href="emaildetail.php?idemail<?php echo $row['idemail']?>"><span><i class=" fa-star"></i></span></a>
                            </div>

                            <div class="email-list-detail"><span class="from"><?PHP echo $row['sujet']; ?></span>
                                <p class="msg"> <?PHP echo $row['reponse']; ?></p>
                            </div>
                        </div>
          <?php }?>               
